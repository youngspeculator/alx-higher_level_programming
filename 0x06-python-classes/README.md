...
what is a class in Python? A class is a USER-DEFINED data structure that binds the data members and methods into a single unit. Class is a blueprint or code template for OBJECT CREATION. Using a class, you can create as many objects as you want.

what is an object in Python? An object is an INSTANCE of a class. It is a collection of attributes(variables) and methods. We use the object of a class to perform actions.

Objects have two characterstics: They have states and behaviors(object has attributes and methods attached to it)Attributes represent its state, and methods represent its behaviour. Using its methods, we can modify its state.
...
-BEHAVIOUR: An object has methods that represent its behavior
...
Object 1: Ghostface Killah
	...
	-State:
		...
		-Profession: Engineer
	-Behavior:
		-Working: He is working as an Engineer at Wu Fin		
		-Study: He studies 6 hours a day
...
Object 2: Nazizi
	...
	-Behavior:
		-Working: She works as a Dev at Nece-Noy
		-Study: She studies 6 hours a day

Ghostface Killah is a male and he works as an Eng.
Nazizi is a female and she works as a Dev.
Both objects are created from the same class, but they have different states and behaviours
